...
Olá! Como parte do processo de seleção da Cogtive, gostaríamos que você fizesse uma 
pequena tarefa. Esperamos que ela seja feita preferencialmente em uma das nossas linguagens principais: 
C#, Javascript ou Go.
